...
// adapted for XMegaForArduino project by S.F.T. Inc. - cleaned up warnings, partially re-factor style for improved readability
 ...
 * the value zero, false, is returned for failure.
 */
uint8_t SdFile::timestamp(uint8_t flags, uint16_t year, uint8_t month, uint8_t day,
